...
const Testimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <div className="max-w-[1120px] w-full mr-auto ml-auto flex flex-col items-center lg:items-start lg:flex-row gap-4">
      <div className="bg-grey-dark lg:max-w-[552px] w-full xs:h-[460px] flex flex-shrink-0 flex-col lg:items-center justify-center lg:text-center border border-[#303030] rounded-[24px] xs:rounded-[50px] text-2xl xs:text-4xl font-bold py-12 px-6 xs:p-16 gap-4">
